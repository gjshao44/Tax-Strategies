...
""",
        ...
        "muni_desc": "Municipal bond interest is excluded from federal income tax. The **tax-equivalent yield** (TEY) shows what a taxable bond must earn to match a muni's after-tax return. At higher brackets, munis become increasingly attractive — and the tax-free income frees up bracket space for Roth conversions.",
...
""",
        ...
        "tab_muni": "🏛️ 免税债券？",
        "muni_h": "是否应配置免税市政债券？",
        "muni_desc": "市政债券利息免联邦所得税。**税等价收益率**（TEY）显示应税债券需要多高的收益率才能匹配免税债券的税后回报。在较高税率下，市政债券更具吸引力——免税收入还能为Roth转换腾出税率空间。",
        "muni_tey_h": "税等价收益率分析",
